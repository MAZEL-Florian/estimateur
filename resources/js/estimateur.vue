    ...
    <div class="container barometre barometre-display">
        ...
        <div class="container">
            <div class="row col col-sm">
                ...
                <div class="d-grid col justify-content-sm-center text-sm-center">
                    <div class="row justify-content-center">
                        ...
                        <input v-model.number="pick" v-bind:value="0.22" class="btn-check" type="radio"
                            name="inlineRadioOptions" id="noncadre" checked>
                        <label class="btn rokett-box mx-auto" for="noncadre">Salarié non-cadre</label>

                        <input v-model.number="pick" v-bind:value="0.25" class="btn-check" type="radio"
                            name="inlineRadioOptions" id="cadre">
                        <label class="btn rokett-box mx-auto" for="cadre">Salarié cadre</label>
                    </div>

                    <div class="row justify-content-center pt-sm-2">
                        <input v-model.number="pick" v-bind:value="0.45" class="btn-check" type="radio"
                            name="inlineRadioOptions" id="professionLiberale">
                        <label class="btn rokett-box mx-auto" for="professionLiberale">Profession libérale</label>

                        <input v-model.number="pick" v-bind:value="0.51" class="btn-check" type="radio"
                            name="inlineRadioOptions" id="portageSalarial">
                ...
                <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="radio-group">
                        <input v-model.number="nbMois" class="rokett-input-mois" v-bind:value="12" type="radio"
                            name="nbMois" id="nbMois12" checked>
                        <label class="rokett-label-mois" for="nbMois12">12</label>

                        <input v-model.number="nbMois" class="rokett-input-mois" v-bind:value="13" type="radio"
                            name="nbMois" id="nbMois13">
                        <label class="rokett-label-mois" for="nbMois13">13</label>

                        <input v-model.number="nbMois" class="rokett-input-mois" v-bind:value="14" type="radio"
                            name="nbMois" id="nbMois14">
                        <label class="rokett-label-mois" for="nbMois14">14</label>

                        <input v-model.number="nbMois" class="rokett-input-mois" v-bind:value="15" type="radio"
                        name="nbMois" id="nbMois15">
                ...
                <input v-model.number="tempsTravail" type="range" class="rokett-input-range" id="tpsTravail" min="0.1"
                    max="1" step="0.1">
            </div>
            ...
            <div class="col-lg-4 col-sm-12">
                ...
                <input disabled type="number" class="form-control rokett-bg-input rokett-no-border rokett-nombre"
                    :placeholder="horaireBrut == '' && mensuelBrut == '' && annuelBrut == '' && horaireNet == '' && mensuelNet == '' && annuelNet == '' ? '0.00' : mensuelNetApresImpots">
                <label for="prelevSource" class="form-label rokett-label mt-3">Taux de prélèvement à la source : {{
                    isNaN(this.prelevSource) ? '0' : Math.round((1 - this.prelevSource) * 100) }}%</label>
            </div>
        </div>
    </div>
</div></template>
